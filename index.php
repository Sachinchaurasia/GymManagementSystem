...
<head>
    ...
    <body>
        ...
        <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3><img src="img/logo3.jpg" alt="Logo" /></h3></div>
                ...
                if (isset($_POST['login']))
                    {
                        ...
                        if ($num_row > 0) 
                            {			
                                ...
                                //header("location:staff\index2.php");
                            }
                        else
                            {
            ...
            ?>
            <div class="pull-left">
            <button><a href="customer/index.php"><h6>Customer Login</h6></a></button>
            </div>

            <div class="pull-right">
          <button>  <a href="staff/index.php"><h6>Staff Login</h6></a></button>
            </div>
